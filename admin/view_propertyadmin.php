...
if(isset($_POST['delete'])){
   ...
   $verify_delete = $conn->prepare("SELECT * FROM `explore` WHERE id = ?");
   $verify_delete->execute([$delete_id]);

   if($verify_delete->rowCount() > 0){
      $select_images = $conn->prepare("SELECT * FROM `explore` WHERE id = ?");
      ...
      $delete_listings = $conn->prepare("DELETE FROM `explore` WHERE id = ?");
...
<section class="view-property">
   ...
   <?php
      $select_properties = $conn->prepare("SELECT * FROM `explore` WHERE id = ? ORDER BY date DESC LIMIT 1");
      ...
      if($select_properties->rowCount() > 0){
         ...
         $select_user->execute([$fetch_property['admin_id']]);
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-dollar-sign"></i><span><?= $fetch_property['currency']; ?></span></p>
         ...
         <p><i class="fas fa-building"></i><span><?= $fetch_property['city']; ?></span></p>
      ...
      <div class="flex">
         <div class="box">
            <p><i>number of entries :</i><span><?= $fetch_property['bhk']; ?></span></p>
            <p><i>land area : </i><span><span style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
            <p><i>measurment unit :</i><span><?= $fetch_property['status']; ?></span></p>
            <p><i>bedroom :</i><span><?= $fetch_property['bedroom']; ?></span></p>
            <p><i>bathroom :</i><span><?= $fetch_property['bathroom']; ?></span></p>
            <p><i>kitchen :</i><span><?= $fetch_property['balcony']; ?></span></p>
            <p><i>halls :</i><span><?= $fetch_property['halls']; ?></span></p>
         </div>
         <div class="box">
            <p><i>built area :</i><span><?= $fetch_property['carpet']; ?></span></p>
            <p><i>age :</i><span><?= $fetch_property['age']; ?> years</span></p>
            <p><i>total floors :</i><span><?= $fetch_property['total_floors']; ?></span></p>
            <p><i>number of streets :</i><span><?= $fetch_property['room_floor']; ?></span></p>
            <p><i>payment method :</i><span><?= $fetch_property['furnished']; ?></span></p>
            <p><i>Construction type :</i><span><?= $fetch_property['loan']; ?></span></p>
            <p><i>finishing type :</i><span><?= $fetch_property['finishing']; ?></span></p>
            <p><i>contract type :</i><span><?= $fetch_property['contract']; ?></span></p>
         </div>
      </div>
