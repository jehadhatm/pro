...
<div class="box-container">
      ...
      <div class="box" >
        <?php
         ...
         $user_image = $fetch_profile['uimage']; // Get the value of the `uimage` column
         ?>
         <h3>welcome!</h3>
         <p><?= $fetch_profile['name']; ?></p>
         <?php if (!empty($user_image)) { ?>
         <img src="images/<?= $user_image; ?>"height="200px" width="200px" alt="User Image"> <!-- Display the user image if it exists -->
         <?php } else { ?>
         <img src="images/default-image.jpg" alt="Default Image"> <!-- Display a default image if the user image is empty -->
         <?php } ?>
