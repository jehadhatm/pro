...
if (isset($_POST['post'])) {
   ...
   $halls = $_POST['halls'];
   $halls = filter_var($halls, FILTER_SANITIZE_STRING);
   
   $finishing = $_POST['finishing'];
   $finishing = filter_var($finishing, FILTER_SANITIZE_STRING);
   ...
   if ($image_01_size > 2000000) {
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, user_id, property_name, address, city, price, currency, type, offer, contract, status, furnished, halls, bhk, deposite, bedroom, bathroom, balcony, carpet, age, finishing, total_floors, room_floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
      $insert_property->execute([$id, $user_id, $property_name, $address, $city, $price, $currency, $type, $offer, $contract, $status, $furnished, $halls, $bhk, $deposite, $bedroom, $bathroom, $balcony, $carpet, $age, $finishing, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05, $description]);
      ...
      <form action="" method="POST" enctype="multipart/form-data">
         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="currency" required class="input">
                  <option value="YEMENI REAL">YEMENI REAL</option>
                  <option value="USD">USD</option>
                  <option value="SAUDI REAL">SAUDI REAL</option>
               </select>
            </div>
            ...
            <div class="box">
               ...
               <select name="city" required class="input">
                  ...
                  <option value="hodidah">hodidah</option>
            ...
            <div class="box">
               ...
               <select name="contract" required class="input">
                  ...
                  <option value="annual-rental">annual-rental</option>
            ...
            <div class="box">
               <p>Measruing unit <span>*</span></p>
               <select name="status" required class="input">
                  <option value="sana'a">sanaani unit</option>
                  <option value="amrani">amrani unit</option>
                  <option value="hodaidi">hodaidi unit</option>
                  <option value="damar">damari unit</option>
                  <option value="taizi">taizi unit</option>
                  <option value="ibb">ibby unit</option>
                  <option value="meter sq">square meters</option>
               </select>
            </div>
            
            <div class="box">
               <p>Number of entries <span>*</span></p>
            ...
            <div class="box">
               <p>Number of kitchens <span>*</span></p>
            ...
            <div class="box">
               <p>Number of halls <span>*</span></p>
               <select name="halls" required class="input">
                  <option value="0">0 </option>   
                  <option value="1">1 </option>
                  <option value="2">2 </option>
                  <option value="3">3 </option>
            ...
            <div class="box">
               <p>TYPE of finishing <span>*</span></p>
               <select name="finishing" required class="input">
                  <option value="none">NONE</option>   
                  <option value="semi-finished">semi-finished </option>
                  <option value="full-finishing">full-finishing</option>
            ...
            <div class="box">
               <p>Number of streets <span>*</span></p>
               <input type="number" name="room_floor" required min="0" max="99" maxlength="2"
                  placeholder="enter Number of streets" class="input">
            </div>
            <div class="box">
               <p>Construction type <span>*</span></p>
         ...
         <div class="checkbox">
            <div class="box">
               ...
               <div class="multichoice">
                  <label>
                     <input type="checkbox" name="lift" value="yes" onclick="toggleSelection(this)">
                     lifts
                  </label>
                  <label>
                     <input type="checkbox" name="security_guard" value="yes" onclick="toggleSelection(this)">
                     security guard
                  </label>
                  <label>
                     <input type="checkbox" name="play_ground" value="yes" onclick="toggleSelection(this)">
                     play ground
                  </label>
                  <label>
                     <input type="checkbox" name="garden" value="yes" onclick="toggleSelection(this)">
                     gardens
                  </label>
                  <label>
                     <input type="checkbox" name="power_backup" value="yes" onclick="toggleSelection(this)">
                     power backup
                  </label>
                  <label>
                     <input type="checkbox" name="parking_area" value="yes" onclick="toggleSelection(this)">
                     parking area
                  </label>
                  <label>
                     <input type="checkbox" name="gym" value="yes" onclick="toggleSelection(this)">
                     gym
                  </label>
                  <label>
                     <input type="checkbox" name="shopping_mall" value="yes" onclick="toggleSelection(this)">
                     shopping mall
                  </label>
                  <label>
                     <input type="checkbox" name="hospital" value="yes" onclick="toggleSelection(this)">
                     hospital
                  </label>
                  <label>
                     <input type="checkbox" name="school" value="yes" onclick="toggleSelection(this)">
                     school
                  </label>
                  <label>
                     <input type="checkbox" name="market_area" value="yes" onclick="toggleSelection(this)">
                     market_area
                  </label>

                  <label>
                     <input type="checkbox" name="water_supply" value="yes" onclick="toggleSelection(this)">
                     water_supply
                  </label>
