         ...
         <div class="flex">
            ...
            <div class="box">
               ...
               <select name="min" class="input" required>
                  ...
                  <option value="20000000">2B</option>
                  <option value="30000000">3B</option>
                  <option value="40000000">4B</option>
                  <option value="50000000">5B</option>
                  <option value="60000000">6B</option>
                  <option value="70000000">7B</option>
                  <option value="80000000">8B</option>
                  <option value="90000000">9B</option>
                  <option value="100000000">10B</option>
                  <option value="150000000">15B</option>
                  <option value="200000000">20B</option>
               </select>
            </div>
            <div class="box">
               <p>maximum budget</p>
