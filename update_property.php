...
if(isset($_POST['update'])){
   ...
   $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, city = ?, price = ?, currency = ?, type = ?, offer = ?, contract = ?, status = ?, furnished = ?, halls = ?, bhk = ?, deposite = ?, bedroom = ?, bathroom = ?, carpet = ?, age = ?, finishig = ?, total_floors = ?, room_floor = ?, loan = ?, lift = ?, security_guard = ?, play_ground = ?, garden = ?, water_supply = ?, power_backup = ?, parking_area = ?, gym = ?, shopping_mall = ?, hospital = ?, school = ?, market_area = ?, description = ? WHERE id = ?");   
   $update_listing->execute([$property_name, $address, $city, $price, $currency, $type, $offer, $contract, $status, $furnished, $halls, $bhk, $deposite, $bedroom, $bathroom, $carpet, $age, $finishing, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $description, $update_id]);
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="box">
               ...
               <option value= "<?= $fetch_property['currency']; ?>" selected><?= $fetch_property['currency']; ?> </option>
            ...
            <div class="box">
               ...
               <option value= "<?= $fetch_property['furnished']; ?>" selected><?= $fetch_property['furnished']; ?> </option></option>  
         ...
         <div class="box">
            ...
            <input type="number" name="deposite" required min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="enter land area" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            <p>how many kitchens <span>*</span></p>
         ...
         <div class="box">
               ...
               <option value="<?= $fetch_property['halls']; ?>" selected><?= $fetch_property['halls']; ?></option>   
               <option value="0">0 </option>   
                  <option value="1">1 </option>
                  <option value="2">2 </option>
                  <option value="3">3 </option>
         ...
         <div class="box">
               ...
               <option value="<?= $fetch_property['finishing']; ?>" selected><?= $fetch_property['finishing']; ?></option>      
         ...
         <div class="box">
            ...
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="number of streets" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
